...
extern unsigned char _binary_hashset_bin_start;
extern unsigned char _binary_hashset_bin_end;
extern unsigned char _binary_hashset_bin_size;


int main(int argc,char* argv[]) {
	HashSet& entries = *reinterpret_cast<HashSet*>(&_binary_hashset_bin_start);
